...
```bash
 Dec 16 19:53:03 ht2-100-11111 dovecot: imap-login: Aborted login (no auth attempts in 1 secs): user=<>, rip=xxx.xx.xxx.xxx, lip=yyy.yy.yyy.yy, TLS, session= 
```
...
```bash
 Dec 16 19:53:03 ht2-100-11111 dovecot: imap-login: Login: user=, method=CRAM-MD5, rip=xxx.xx.xxx.xxx, lip=yyy.yy.yyy.yy, mpid=481, TLS, session= 
```
